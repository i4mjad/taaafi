...
class FollowUpCalender extends StatefulWidget {
  FollowUpCalender({Key key}) : super(key: key);

  @override
  State<FollowUpCalender> createState() => _FollowUpCalenderState();
}
...
class _FollowUpCalenderState extends State<FollowUpCalender> {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        Text(AppLocalizations.of(context).translate("relapse")),
        SizedBox(
          height: 12,
        ),
        Container(
  ...
  void dateChecker(DateTime firstDate, DateTime date, BuildContext context) {
