  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    var records = [
      ...
      ActivityTask("4", 'ممارسة الرياضة', "النشاط البدني", "3", true,
          DateTime(2024, 5, 3), ""),
      ActivityTask("5", 'قراءة كتاب', "التعلم الذاتي", "4", true,
          DateTime(2024, 5, 3), ""),
      ActivityTask(
      ...
      ActivityTask("7", 'كتابة اليوميات', "تدوين الرحلة", "6", true,
          DateTime(2024, 5, 4), ""),
      ActivityTask(
          "8", 'التأمل', "الاسترخاء", "7", true, DateTime(2024, 5, 5), ""),
      ActivityTask(
      ...
      ActivityTask("23", 'كتابة اليوميات', "تدوين الرحلة", "22", true,
          DateTime(2024, 5, 12), ""),
      ActivityTask("24", 'مشاهدة فيلم', "الترفيه", "23", false,
          DateTime(2024, 5, 13), ""),
      ...
      ActivityTask("39", 'تطوير مهارة جديدة', "التعلم الذاتي", "38", true,
          DateTime(2024, 5, 20), ""),
      ActivityTask("40", 'مشاهدة فيلم', "الترفيه", "39", false,
          DateTime(2024, 5, 21), ""),
