...
enum FocusLogger {
  static let logger = Logger(subsystem: Bundle.main.bundleIdentifier ?? "com.taaafi.app", category: "FocusReport")
  
  @inlinable static func d(_ msg: String) {
    #if DEBUG
    logger.debug("\(msg, privacy: .public)")
    #endif
    FocusShared.appendLog("D [Report] \(msg)")
  }
  ...
  @inlinable static func e(_ msg: String) {
    ...
    #endif
    FocusShared.appendLog("E [Report] \(msg)")
  }
