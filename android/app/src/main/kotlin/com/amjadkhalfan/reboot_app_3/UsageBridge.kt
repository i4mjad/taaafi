...
class UsageBridge(private val ctx: Context) {
  ...
  fun todaySnapshot(): JSONObject {
    ...
    return JSONObject().put("apps", apps).put("domains", JSONArray()).put("pickups", pickups).put("notifications", JSONObject.NULL).put("generatedAt", System.currentTimeMillis()/1000)
  }
}
